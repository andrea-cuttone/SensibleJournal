...
public class TutorialCard4 extends Card {
    ...
    public TutorialCard4(Context context) {
	...
	private void init(){        	       
        ...
        thumbnail.setDrawableResource(R.drawable.screen4);
        ...
        this.setOnSwipeListener(new Card.OnSwipeListener() {
            ...
            public void onSwipe(Card card) {
                ...
                editor.putBoolean("tutorial4Gone", true);
                editor.commit();
            }
        });               
    ...
    public void setupInnerViewElements(ViewGroup parent, View view) {
        ...
        dismissButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
                ...
                Constants.cards.remove(Constants.tutorialCard4);
	    ...
	    if (tutorialText != null) tutorialText.setText(R.string.tutorial4_text);    
