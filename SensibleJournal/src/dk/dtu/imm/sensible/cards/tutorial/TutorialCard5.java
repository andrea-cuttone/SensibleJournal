...
public class TutorialCard5 extends Card {
	
	private TextView tutorialText;
    private Context context;
    private CustomThumbCard thumbnail;

    public TutorialCard5(Context context) {
	...
	private void init(){        	       
        ...
        thumbnail.setDrawableResource(R.drawable.screen5);
        ...
        this.setOnSwipeListener(new Card.OnSwipeListener() {
            ...
            public void onSwipe(Card card) {
                ...
                editor.putBoolean("tutorial5Gone", true);
                editor.commit();
            }
        });
    ...
    public void setupInnerViewElements(ViewGroup parent, View view) {
	    ...
	    if (tutorialText != null) tutorialText.setText(R.string.tutorial5_text);    
